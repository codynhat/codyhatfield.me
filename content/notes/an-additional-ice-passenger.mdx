...
slug: /2020/05/an-additional-ice-passenger
---
...
import { ICEChart } from '../components/an-additional-ice-passenger/ICEChart';

<ICEChart />

[Raw Data](/data/an-additional-ice-passenger.csv)
